 ...
 */
export const joinWaitlist = async (waitlistEntry: WaitlistEntry, options?: Parameters<typeof customFetch>[1]): Promise<WaitlistResult> => {
 ...
 */
export const getWaitlistCount = async ( options?: Parameters<typeof customFetch>[1]): Promise<WaitlistStats> => {

  return customFetch<WaitlistStats>(getGetWaitlistCountUrl(),
  {
    ...options,
    method: 'GET'
