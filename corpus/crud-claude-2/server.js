...
const selectAll = db.prepare('SELECT * FROM products ORDER BY created_at DESC, id DESC');
...
function toIdParam(req, res, next) {
...
app.get('/api/products/:id', toIdParam, (req, res) => {
...
app.put('/api/products/:id', toIdParam, (req, res) => {
...
app.delete('/api/products/:id', toIdParam, (req, res) => {
