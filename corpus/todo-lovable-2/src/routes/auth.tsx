...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in · Tally" },
      { name: "description", content: "Sign in or create an account to manage your to-dos." },
      { property: "og:title", content: "Sign in · Tally" },
      { property: "og:description", content: "Sign in or create an account to manage your to-dos." },
    ],
  }),
  component: AuthPage,
});
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border bg-card p-8 shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin" ? "Sign in to see your tasks." : "It only takes a second."}
          </p>
