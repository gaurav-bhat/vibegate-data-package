 ...
 */
export const getWaitlist = async ( options?: Parameters<typeof customFetch>[1]): Promise<WaitlistEntry[]> => {

  return customFetch<WaitlistEntry[]>(getGetWaitlistUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetWaitlistQueryOptions = <TData = Awaited<ReturnType<typeof getWaitlist>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWaitlist>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetWaitlistQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getWaitlist>>> = ({ signal }) => getWaitlist({ signal, ...requestOptions });
...
export function useGetWaitlist<TData = Awaited<ReturnType<typeof getWaitlist>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWaitlist>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetWaitlistQueryOptions(options)
