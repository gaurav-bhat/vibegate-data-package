 ...
 */
export const createImage = async (galleryImageInput: GalleryImageInput, options?: Parameters<typeof customFetch>[1]): Promise<GalleryImage> => {
...
export const getCreateImageMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createImage>>, TError,{data: BodyType<GalleryImageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createImage>>, TError,{data: BodyType<GalleryImageInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createImage>>, {data: BodyType<GalleryImageInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateImageMutationBody = BodyType<GalleryImageInput>
 ...
 */
export const getGalleryStats = async ( options?: Parameters<typeof customFetch>[1]): Promise<GalleryStats> => {
